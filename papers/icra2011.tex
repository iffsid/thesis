...
\begin{figure}
\begin{center}
\resizebox{3in}{!}{\includegraphics[width=0.5\textwidth]{images/log-parameters.png}}
\end{center}
\vskip -15px
...
%
We refer to this set of lines as the \defoccur{grid} (see Fig.~\ref{fig:pose}).
%
...
\resizebox{1.6in}{!}{\includegraphics[width=0.49\textwidth]{images/pose1-cut.jpg}}
% &
\resizebox{1.6in}{!}{\includegraphics[width=0.49\textwidth]{images/pose2-cut.jpg}}
% \end{tabular}
\end{center}
%
...
\begin{figure}
\begin{center}
\includegraphics[width=0.49\textwidth]{images/random-variables.png}
\end{center}
%
\vskip -20px
...
%
Fig.~\ref{fig:endsandsegs} depicts the log ends and log segments that
...
\LincolnLogs\ (section~\ref{sec:grammar}).
%
We take image evidence to impose priors on the variables~$Z^+_q$, $Z^-_q$,
$Z^u_q$, $Z^v_q$, and~$Z^w_q$ (sections~\ref{sec:evidence}
and~\ref{sec:mapping}) and solve this stochastic CSP to perform structure
estimation (section~\ref{sec:structure}).

\subsection{Evidence for the presence or absence of logs}
\label{sec:evidence}
\begin{figure}
\begin{center}
\resizebox{3in}{!}{\includegraphics[width=0.5\textwidth]{images/ellipse-filter-small.jpg}}
\end{center}
\vskip -10px
...
\begin{center}
\hskip -10px
\resizebox{3.5in}{!}{\includegraphics[width=0.5\textwidth]{images/graph.png}}
\end{center}
\vskip -8px
%
...
\includegraphics[width=0.195\textwidth]{images/1263244065-1200-ll.jpg}\\
...
\includegraphics[width=0.195\textwidth]{images/1263242135-1800-ll.jpg}\\
