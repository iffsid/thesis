...
\begin{figure}
  ...
  \begin{tabular}{@{}c@{\hspace{2pt}}c@{}}
    \raisebox{7pt}{\includegraphics[width=0.25\textwidth]{images/real-log-qw}}&
  ...
  \begin{tabular}{@{}c@{\hspace{8pt}}c@{}}
    \begin{small}
      \begin{tabular}{@{}p{0.48\textwidth}@{}}
        2-notch logs occupy 2 adjacent grid points\\[0.8ex]
        3-notch logs occupy 3 adjacent grid points\\[0.8ex]
        1- and 2-notch logs must be supported at all notches\\[0.8ex]
        3-notch logs must be supported in at least 2 notches\\[0.8ex]
        log ends must be at the ends of logs\\[0.8ex]
        short segments indicate occupancy above or below\\[0.8ex]
        long segments indicate presence of a multi-notch log\\
      \end{tabular}
    \end{small}&
    \begin{tabular}{@{}c@{\hspace{2pt}}c@{}}
      \includegraphics[width=0.19\textwidth]{images/valid-assemblies-1}&
      \includegraphics[width=0.19\textwidth]{images/valid-assemblies-2}\\[-0.3ex]
      \includegraphics[width=0.19\textwidth]{images/invalid-assemblies-1}&
      \includegraphics[width=0.19\textwidth]{images/invalid-assemblies-2}\\
    \end{tabular}\\
     {\small (a)}&{\small (b)}\\
  \end{tabular}
  %
...
\begin{figure}
  \centering
  \begin{tabular}{@{}cc@{}}
    \begin{tabular}[b]{@{}c@{\hspace*{2pt}}c@{}}
    \includegraphics[width=0.225\textwidth]{images/log-end-visibility}&
    \includegraphics[width=0.225\textwidth]{images/log-segment-visibility}\\
     {\small (a)}&{\small (b)}\\
    \multicolumn{2}{@{}c@{}}{\scalebox{0.6}{\begin{tabular}[b]{@{\hspace{4pt}}c@{\hspace{10pt}}r@{\hspace{10pt}}r@{\hspace{10pt}}r@{\hspace{4pt}}}
    \hline\\[-2ex]
    ...
    \end{tabular}&
    \begin{tabular}[b]{@{}c@{}}
      \includegraphics[width=0.415\textwidth]{images/robots}\\{\small (d)}
    \end{tabular}
  \end{tabular}
  %
  \par\vspace*{-2ex}
